...
define('poly', function(poly){
  poly = Object.create(Object.prototype);
  ...
  function typedef(identifier, generator) {
    poly[identifier] = new Type(identifier, generator);
  }
  ...
  function TFun() {
    ...
    return new Type(description, compose_generators(poly.Fun.generator, new_generator));
  }

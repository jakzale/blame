    ...
    if ((A instanceof Fun) && (B instanceof Fun) && A.domain.length === B.domain.length && A.optional.length === B.optional.length && !!A.repeated === !!B.repeated) {
      ...
      return new Proxy(value, {
        apply: function (target, thisValue, args) {
          ...
          } else if (args.length > A.domain.length + A.optional.length && !A.repeated) {
      ...
      return new Proxy(value, {
        get: function (target, name, receiver) {
          ...
          var ARRAY_API = {
            ...
            join: function () {
              return new Fun([], [blame.Str], null, blame.Str);
            ...
            //// TODO: This one does not work, because it calls join with not arguments
            toString: function () {
              return blame.fun(blame.Str);
            }
          };

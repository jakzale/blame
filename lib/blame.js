...
define('blame', [], function () {
  'use strict';
  var blame, count, Num, Bool, Str, Und, Any, Forall, fun, arr, tyvar, forall, sum, wrap;
  ...
  function wrap_array(value, p, q, A, B) {
    return new Proxy(value, {
      get: function (target, name, receiver) {
        ...
        ARRAY_API = Object.create(null);

          // --- Properties ---
        ARRAY_API.length = function () {
          return Num;
        };
        // TODO = Add object features
        ARRAY_API.prototype = function () {
          return Any;
        };
        // --- Methods ---
        ARRAY_API.concat = function (A) {
          var T = A.type;

          return fun(null, null, sum([T, A]), A);
        };
        ARRAY_API.every = function (A) {
          var T = A.type,
            fun_type = func(T, Num, A, Bool);

          return fun([fun_type], [Any], null, Bool);
        };
        ARRAY_API.filter = function (A) {
          var T = A.type,
            fun_type = func(T, Num, A, Bool);

          return fun([fun_type], [Any], null, A);
        };
        ARRAY_API.forEach = function (A) {
          var T = A.type,
            fun_type = func(T, Num, A, Und);

          return fun([fun_type], [A], null, Und);
        };
        ARRAY_API.indexOf = function (A) {
          var T = A.type;

          return fun([T], [Num], null, Num);
        };
        ARRAY_API.join = function () {
          return fun(null, [Str], null, Str);
        };
        ARRAY_API.lastIndexOf = function (A) {
          var T = A.type;

          return fun([T], [Num], null, Num);
        };
        ARRAY_API.map = function (A) {
          var T = A.type,
            fun_type = func(T, Num, A, tyvar('Z'));

          return forall('Z', fun([fun_type], [Any], null, arr(tyvar('Z'))));
        };
        ARRAY_API.pop = function (A) {
          var T = A.type;

          return func(T);
        };
        ARRAY_API.push = function (A) {
          var T = A.type;

          return fun(null, null, T, Num);
        };
        ARRAY_API.reduce = function (A) {
          var T = A.type,
            fun_type = func(sum([tyvar('Z'), T]), T, Num, A, tyvar('Z'));

          return forall('Z', fun([fun_type], [tyvar('Z')], null,  tyvar('Z')));
        };
        ARRAY_API.reduceRight = function (A) {
          var T = A.type,
            fun_type = func(sum([tyvar('Z'), T]), T, Num, A, tyvar('Z'));

          return forall('Z', fun([fun_type], [tyvar('Z')], null,  tyvar('Z')));
        };
        ARRAY_API.reverse = function (A) {
          return func(A);
        };
        ARRAY_API.shift = function (A) {
          var T = A.type;

          return func(T);
        };
        ARRAY_API.slice = function (A) {
          return fun(null, [Num, Num], null, A);
        };
        ARRAY_API.some = function (A) {
          var T = A.type,
            fun_type = func(T, Num, A, Bool);

          return fun([fun_type], [Any], null, Bool);
        };
        ARRAY_API.sort = function (A) {
          var T = A.type,
            fun_type = func(T, T, Num);

          return fun(null, [fun_type], null, A);
        };
        ARRAY_API.toLocaleString = function () {
          return func(Str);
        };
        ARRAY_API.toString = function () {
          return func(Str);
        };
        ARRAY_API.unshift = function (A) {
          var T = A.type;

          return fun(null, null, T, Num);
        };
        // --- Object.prototype ---
        ARRAY_API.hasOwnProperty = function () {
          return func(Str, Bool);
        };
        ARRAY_API.valueOf = function (A) {
          return func(A);
        };

...
define('blame', [], function () {
  'use strict';
  var blame, count, Num, Bool, Str, Und, Any, Forall, fun, arr, tyvar, forall, sum, wrap, ARRAY_API;
 ...
 *      map_type = forall('Z', fun([fun_type], [Any], null, arr(tyvar('Z'))));
 *
 *      return map_type;
 *    }
 *  };
 ...
 *  };
 *
 *  // TODO: Figure if this element is needed
 *  ARRAY_API.reverse = {
 *    get: function (A) {
 *      return func(A);
 *    }

...
define('blame', [], function () {
  ...
  function TFun() {
    ...
    function contract(fun, label, context, is_unseal) {
      var negated, handler;
      ...
      function wrap_argument(context) {
        return function (arg, index) {
          return domain[index].contract.call(undefined, arg, negated, context, !is_unseal);
        };
      }
      ...
      handler = {
        apply: function (target, thisArg, args) {
          ...
          return range.contract.call(undefined, result, label, context, is_unseal);
        },
  ...
  function Forall(id, type) {
    ...
    this.contract = function (value, label, context) {
      ...
      var handler = {
        apply: function (target, thisArg, args) {
          var application_context = new Context(my_context),
            wrapped_fun = type.contract.call(undefined, target, label, application_context, true);
  ...
  function TArr(type) {
    ...
    function contract(value, label, context, is_unseal) {
      ...
      var handler = {
        ...
        get: function (target, name, receiver) {
          ...
          if (name === index.toString() && index !== (-1 >>> 0)) {
            return type.contract(target[name], label, context, is_unseal);
          }

          if (ARRAY_API.hasOwnProperty(name)) {
            if (ARRAY_API[name]) {
              return ARRAY_API[name].contract(target[name], label, context);
            }
        ...
        set: function (target, name, value, receiver) {
          ...
          if (name === index.toString() && index !== (-1 >>> 0)) {
            ...
            target[name] = type.contract(value, negated, context, !(is_unseal || false));
          }
        }

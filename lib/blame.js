...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    // AMD
    // Removed dependency on reflect for now
    define('blame', [], function (Reflect) {
      var blame = factory(Reflect);
      //root.blame = blame;
      return blame;
    });
    ...
    // CommonJS
    module.exports = factory(require('harmony-reflect'));
  } else {
    root.blame = factory(root.Reflect);
  }
}(this, function (Reflect) {
  'use strict';

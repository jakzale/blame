  ...
  .action(function () {
    ...
    files.map(function (filename) {
      ...
      fs.readFile(target, { encoding: 'utf8' }, function (err, data) {
        ...
        var declarations = ';(function(){ var Blame = require(\'Blame\'), T = new Blame.LazyTypeCache(), M = Object.create(null);' + parser.compile(basename, data, program.verbose, program.node) + '\nT.verify(); }());';

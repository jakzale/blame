...
declare module TypeScript {
    ...
    class SourceMapperOutput {
        public sourceMapEntries: SourceMapEntry[];
        public sourceMapRootScopes: SourceMapScope[];
        constructor(sourceMapEntries: SourceMapEntry[], sourceMapRootScopes: SourceMapScope[]);
    }
    ...
    */
    class SourceMapScope {
        public parent: SourceMapScope;
        public startLine: number;
        public startColumn: number;
        public endLine: number;
        public endColumn: number;
        static HIDDEN_LOCAL: string;
        public nested: SourceMapScope[];
        private _locals;
        constructor(parent: SourceMapScope, startLine: number, startColumn: number, endLine?: number, endColumn?: number);
        /**
        * Hides a named local
    ...
    class SourceMapper {
        ...
        */
        ...
        private addScopesExtension(sourceMap);
    }
}
declare module TypeScript {
    enum EmitContainer {
...
declare module TypeScript {
    ...
    class OutputFile {
        ...
        public sourceMapOutput: SourceMapperOutput;
        constructor(name: string, writeByteOrderMark: boolean, text: string, fileType: OutputFileType, sourceMapOutput?: SourceMapperOutput);
    }
    class CompileResult {
        public diagnostics: Diagnostic[];
        public outputFiles: OutputFile[];
...
declare module TypeScript.Services {
    ...
    class CompletionSession {
        public fileName: string;
        public position: number;
        public entries: IdentifierNameHashTable<CachedCompletionEntryDetails>;
        constructor(fileName: string, position: number, entries: IdentifierNameHashTable<CachedCompletionEntryDetails>);
    }
}
declare module TypeScript.Services {
